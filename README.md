...
- [ORG_PUBLIC_ALL-v1.4.1.ps1](windows/ORG_PUBLIC_ALL-v1.4.1.ps1) — 公共/共享设备策略（20 分钟空闲注销，盖上即注销，更短电源超时）。
- [ORG_LIMITED_USERS-v1.4.1.ps1](windows/ORG_LIMITED_USERS-v1.4.1.ps1) — 个人受限用户设备策略（2 小时空闲注销，盖上即注销，较宽松电源超时）。
- [CLEAN_ALL-v1.4.1.ps1](windows/CLEAN_ALL-v1.4.1.ps1) — 还原 ORG 策略写入的注册表、计划任务和电源策略。

各脚本会修改的注册表项、共用策略和差异点见 [windows/README.md](windows/README.md)。
